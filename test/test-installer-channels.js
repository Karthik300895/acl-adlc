...
function runTests() {
  ...
  {
    const opts = parseChannelOptions({ pin: ['acl=v1.0.0'], next: ['core'] });
    const warnings = bundledTargetWarnings(opts, ['core', 'acl']);
    assert(
  ...
  {
    const r = parseGitHubRepo('https://github.com/acl-code-org/ACL-ADLC');
    assert(r && r.owner === 'acl-code-org' && r.repo === 'ACL-ADLC', 'https URL basic');
  }
  {
    const r = parseGitHubRepo('https://github.com/acl-code-org/ACL-ADLC.git');
    assert(r && r.repo === 'ACL-ADLC', '.git suffix stripped');
  }
  {
    const r = parseGitHubRepo('https://github.com/acl-code-org/ACL-ADLC/');
    assert(r && r.repo === 'ACL-ADLC', 'trailing slash stripped');
  }
  {
  ...
  assertEqual(
    releaseNotesUrl('https://github.com/acl-code-org/ACL-ADLC', 'v1.2.3'),
    'https://github.com/acl-code-org/ACL-ADLC/releases/tag/v1.2.3',
