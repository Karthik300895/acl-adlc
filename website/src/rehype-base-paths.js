 ...
 *
 * Transforms:
 *   /img/foo.png → /ACL-ADLC/img/foo.png (when base is /ACL-ADLC/)
 *   /llms.txt → /ACL-ADLC/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/ACL-ADLC/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /ACL-ADLC/img/foo.png.
