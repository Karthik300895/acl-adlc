 ...
 * @param {string} options.base - Site base path (e.g., '/ACL-ADLC/')
...
export function detectContentDir(filePath) {
  ...
  // Also check for a standalone 'docs' directory (ACL project structure)
  // Path format: .../acl/docs/file.mdx or .../acl/website/...
