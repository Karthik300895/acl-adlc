---
title: Roadmap
description: What's next for ACL - Features, improvements, and community contributions
---

# The ACL Method: Public Roadmap

The ACL Method, ACL Method Module (ACL), and ACL Builder (BMB) are evolving. Here's what we're working on and what's coming next.
...
<div class="roadmap-future">
  ...
  <div class="roadmap-future-card">
    ...
    <p>Entertainment, security, therapy, roleplay and much more. Expand the ACL Method platform.</p>
  </div>
  <div class="roadmap-future-card">
    <span class="roadmap-emoji">⚡</span>
...
<div class="roadmap-future">
  ...
  <div class="roadmap-future-card">
    <span class="roadmap-emoji">🖥️</span>
    <h4>Official UI</h4>
    <p>A beautiful interface for the entire ACL ecosystem. CLI power, GUI polish.</p>
  </div>
  <div class="roadmap-future-card">
    <span class="roadmap-emoji">🔒</span>
    <h4>ACL in a Box</h4>
  ...
  <div style="text-align: center; margin-top: 3rem; padding: 2rem; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border);">
    ...
    <p style="color: var(--slate-color-400); margin: 0;">
      This is only a partial list of what's planned. The ACL Open Source team welcomes contributors!{" "}<br />
      <a href="https://github.com/acl-code-org/ACL-ADLC" style="color: var(--color-in-progress);">Join us on GitHub</a> to help shape the future of AI-driven development.
    </p>
    <p style="color: var(--slate-color-400); margin: 1.5rem 0 0;">
      Love what we're building? We appreciate both one-time and monthly{" "}<a href="https://buymeacoffee.com/acl" style="color: var(--color-in-progress);">support</a>.
    </p>
