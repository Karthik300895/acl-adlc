...
Les flags d’installation headless et CI, la sélection de canal et l’épinglage de version se trouvent désormais dans le guide unifié [Comment installer ACL](./install-acl.md). Consultez la section [Installations CI non interactives](./install-acl.md#installations-ci-non-interactives) pour la référence des flags et les exemples prêts à copier-coller.
:::
